...
contract NFTmarket is ERC721Enumerable, Ownable {
    ...
    constructor() payable ERC721('Nocturnal creatures', 'NC') {
        maxSupply = 17;
    } 
    ...
    function mintByTokenId(uint8 _tokenId) external payable required {
        mintPerWallet[msg.sender]++;
        _safeMint(msg.sender, _tokenId);
    }

    function mintByLine() external payable required {
        mintPerWallet[msg.sender]++;
